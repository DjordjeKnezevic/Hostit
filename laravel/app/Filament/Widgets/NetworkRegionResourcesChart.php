...
class NetworkRegionResourcesChart extends ChartWidget
{
    protected static ?string $heading = 'Bandwidth per Region Overview';
    public ?string $resourceType = 'bandwidth';
